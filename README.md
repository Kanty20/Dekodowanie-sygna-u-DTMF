...
[ENG] The second stage of the “DTMF signal decoding” exercise involves additional testing of the second harmonics of the eight components tested in point. 2 (in the first stage) in order to eliminate DTMF signal decoding errors caused by acoustic signals 
(speech, music, noise, etc.). Credit for this stage of the exercise will consist of a presentation to the instructor of the operation of the application, a discussion with the instructor, and the submission of the project in electronic form.

Unfortunately, I missed this part.

## Projekt  /  Project

[PL] Projekt został wykonany w trakcie zajęć z Aplikacji procesorów sygnałowych na Politechnice Wrocławskiej.

[ENG] The project was made during a class on Signal Processor Applications at the Wrocław University of Technology.
